...
<div class="dropdown-menu shadow">
    ...
    <select class="form-select btn btn-primary" aria-label="fait une selection" id="ingredients">
...
<select class="form-select btn btn-primary" aria-label="fait une selection" id="ustensiles">
    <option selected>Ustensiles</option>
</select>
`
...
<select class="form-select btn btn-primary" aria-label="fait une selection" id="appareils">
    <option selected>Appareils</option>
</select>
`
